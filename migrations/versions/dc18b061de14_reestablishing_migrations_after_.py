"""Reestablishing migrations after deleting directory and dropping databases

Revision ID: dc18b061de14
Revises: 
Create Date: 2023-01-29 22:13:43.764200
...
def upgrade():
    ...
    sa.Column('location_lat', sa.Numeric(precision=8, scale=6), nullable=False),
    sa.Column('location_lng', sa.Numeric(precision=9, scale=6), nullable=False),
    ...
    sa.Column('user_last_updated', sa.DateTime(), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
